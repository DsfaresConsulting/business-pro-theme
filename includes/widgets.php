...
// Register Front Page About widget area.
genesis_register_sidebar( array(
	'id'          => 'front-page-about',
	'name'        => __( 'Front Page About', 'business-pro-theme' ),
	'description' => __( 'This is the Front Page About widget area.', 'business-pro-theme' ),
) );
